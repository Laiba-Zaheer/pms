...
<head>
    ...
    <title>Commercial Properties - Property Management System</title>
...
<div class="container py-4">
    <div class="row g-4">
        <?php
        // Only show commercial properties
        $query = "SELECT * FROM post WHERE `p-category` = 'commercial'";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            echo "<p class='text-center text-muted'>No commercial properties found in the database.</p>";
        }
        ?>
    </div>
</div>

<span class="footer-span">Commercial Property</span>
